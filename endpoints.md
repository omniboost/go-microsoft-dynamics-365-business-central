...
- [ ] [GET api/{database}/ActivePassiveStateNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-ActivePassiveStateNVL)
...
- [ ] [GET api/{database}/CompanyDetails](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-CompanyDetails)
...
- [ ] [GET api/{database}/CostCentreNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-CostCentreNVL)
...
- [ ] [GET api/{database}/CustomerInvoiceStatistics/{customerId}?referenceDate={referenceDate}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-CustomerInvoiceStatistics-customerId_referenceDate)
...
- [ ] [GET api/{database}/DbDocumentList/FolderList/{organizationId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-DbDocumentList-FolderList-organizationId)
...
- [ ] [GET api/{database}/DueCustomerInvoiceStatistics/ByDate/{referenceDate}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-DueCustomerInvoiceStatistics-ByDate-referenceDate)
...
- [ ] [GET api/{database}/LanguageInfo/{languageId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-LanguageInfo-languageId)
...
- [ ] [DELETE api/{database}/Note/{noteId}](https://api.online.unit4.nl/V19/Help/Api/DELETE-api-database-Note-noteId)
...
- [ ] [GET api/{database}/OrderInfo/ByInvoiceId/{invoiceId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-OrderInfo-ByInvoiceId-invoiceId)
...
- [ ] [GET api/{database}/OrderTypeNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-OrderTypeNVL)
...
- [ ] [POST api/{database}/Payable](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-Payable)
...
- [ ] [GET api/{database}/PurchaseOrganizationNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-PurchaseOrganizationNVL)
...
- [ ] [GET api/{database}/SelectionListNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SelectionListNVL)

## SequenceNVL

- [ ] [GET api/{database}/SequenceNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SequenceNVL)

## SpecifyByNVL

- [ ] [GET api/{database}/SpecifyByNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SpecifyByNVL)

## SpecPrice

- [ ] [DELETE api/{database}/SpecPrice/{specPriceId}](https://api.online.unit4.nl/V19/Help/Api/DELETE-api-database-SpecPrice-specPriceId)
- [ ] [GET api/{database}/SpecPrice/{specPriceId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SpecPrice-specPriceId)
- [ ] [POST api/{database}/SpecPrice](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-SpecPrice)
- [ ] [PUT api/{database}/SpecPrice/{specPriceId}](https://api.online.unit4.nl/V19/Help/Api/PUT-api-database-SpecPrice-specPriceId)

## StockProductNVL

- [ ] [GET api/{database}/StockProductNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-StockProductNVL)

## SubAdminDomainInfo

- [ ] [GET api/{database}/SubAdminDomainInfo/{domainId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SubAdminDomainInfo-domainId)

## SubAdminDomainInfoList

- [ ] [GET api/{database}/SubAdminDomainInfoList](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SubAdminDomainInfoList)

## SubAdminDomainValueInfo

- [ ] [GET api/{database}/SubAdminDomainValueInfo/{domainId}/{domainValueId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SubAdminDomainValueInfo-domainId-domainValueId)

## SubAdminDomainValueInfoList

- [ ] [GET api/{database}/SubAdminDomainValueInfoList/{domainId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SubAdminDomainValueInfoList-domainId)

## SubAdminInfo

- [ ] [GET api/{database}/SubAdminInfo/{subAdminId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SubAdminInfo-subAdminId)

## SubAdminInfoList

- [ ] [GET api/{database}/SubAdminInfoList](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SubAdminInfoList)

## SubAdminSpecList

- [ ] [GET api/{database}/SubAdminSpecList/{fiscalYear}/{accountId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SubAdminSpecList-fiscalYear-accountId)

## SubprojectDescriptionNVL

- [ ] [GET api/{database}/SubprojectDescriptionNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SubprojectDescriptionNVL)

## SubprojectNVL

- [ ] [GET api/{database}/SubprojectNVL/{projectId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SubprojectNVL-projectId)

## Subscription

- [ ] [DELETE api/{database}/Subscription/{subscriptionId}](https://api.online.unit4.nl/V19/Help/Api/DELETE-api-database-Subscription-subscriptionId)
- [ ] [GET api/{database}/Subscription/{subscriptionId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-Subscription-subscriptionId)
- [ ] [POST api/{database}/Subscription](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-Subscription)
- [ ] [PUT api/{database}/Subscription/{subscriptionId}](https://api.online.unit4.nl/V19/Help/Api/PUT-api-database-Subscription-subscriptionId)

## SubscriptionContactPersonNVL

- [ ] [GET api/{database}/SubscriptionContactPersonNVL/{customerId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SubscriptionContactPersonNVL-customerId)

## SubscriptionTypeNVL

- [ ] [GET api/{database}/SubscriptionTypeNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SubscriptionTypeNVL)

## SuffixNVL

- [ ] [GET api/{database}/SuffixNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SuffixNVL)

## SupInvProjectEntryTypeNVL

- [ ] [GET api/{database}/SupInvProjectEntryTypeNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupInvProjectEntryTypeNVL)

## Supplier

- [ ] [DELETE api/{database}/Supplier/SupplierAndOrganization/{supplierId}](https://api.online.unit4.nl/V19/Help/Api/DELETE-api-database-Supplier-SupplierAndOrganization-supplierId)
- [ ] [DELETE api/{database}/Supplier/{supplierId}](https://api.online.unit4.nl/V19/Help/Api/DELETE-api-database-Supplier-supplierId)
- [ ] [GET api/{database}/Supplier/{supplierId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-Supplier-supplierId)
- [ ] [POST api/{database}/Supplier](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-Supplier)
- [ ] [PUT api/{database}/Supplier/{supplierId}](https://api.online.unit4.nl/V19/Help/Api/PUT-api-database-Supplier-supplierId)

## SupplierGroupInfo

- [ ] [GET api/{database}/SupplierGroupInfo/{supplierGroupId}?fiscalYear={fiscalYear}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierGroupInfo-supplierGroupId_fiscalYear)
- [ ] [GET api/{database}/SupplierGroupInfo/{supplierGroupId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierGroupInfo-supplierGroupId)

## SupplierGroupNVL

- [ ] [GET api/{database}/SupplierGroupNVL?fiscalYear={fiscalYear}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierGroupNVL_fiscalYear)
- [ ] [GET api/{database}/SupplierGroupNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierGroupNVL)

## SupplierInfo

- [ ] [GET api/{database}/SupplierInfo/{supplierId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInfo-supplierId)

## SupplierInfoList

- [ ] [GET api/{database}/SupplierInfoList](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInfoList)

## SupplierInvoice

- [ ] [DELETE api/{database}/SupplierInvoice/{invoiceId}](https://api.online.unit4.nl/V19/Help/Api/DELETE-api-database-SupplierInvoice-invoiceId)
- [ ] [GET api/{database}/SupplierInvoice/{invoiceId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInvoice-invoiceId)
- [ ] [POST api/{database}/SupplierInvoice](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-SupplierInvoice)
- [ ] [PUT api/{database}/SupplierInvoice/{invoiceId}](https://api.online.unit4.nl/V19/Help/Api/PUT-api-database-SupplierInvoice-invoiceId)

## SupplierInvoiceInfo

- [ ] [GET api/{database}/SupplierInvoiceInfo/OnlyHeader/{invoiceId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInvoiceInfo-OnlyHeader-invoiceId)
- [ ] [GET api/{database}/SupplierInvoiceInfo/{invoiceId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInvoiceInfo-invoiceId)

## SupplierInvoiceInfoList

- [ ] [GET api/{database}/SupplierInvoiceInfoList/ByFiscalYear/{fiscalYear}/{invoiceState}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInvoiceInfoList-ByFiscalYear-fiscalYear-invoiceState)
- [ ] [GET api/{database}/SupplierInvoiceInfoList/ByFiscalYear/{fiscalYear}/{invoiceState}?id={id}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInvoiceInfoList-ByFiscalYear-fiscalYear-invoiceState_id)
- [ ] [GET api/{database}/SupplierInvoiceInfoList/ByFiscalYear/{fiscalYear}/{id}?invoiceState={invoiceState}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInvoiceInfoList-ByFiscalYear-fiscalYear-id_invoiceState)
- [ ] [GET api/{database}/SupplierInvoiceInfoList/ByFiscalYear/{fiscalYear}/{id}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInvoiceInfoList-ByFiscalYear-fiscalYear-id)
- [ ] [GET api/{database}/SupplierInvoiceInfoList/OpenInvoices/{id}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInvoiceInfoList-OpenInvoices-id)
- [ ] [GET api/{database}/SupplierInvoiceInfoList/{Id}/{startDate}/{endDate}?invoiceState={invoiceState}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInvoiceInfoList-Id-startDate-endDate_invoiceState)
- [ ] [GET api/{database}/SupplierInvoiceInfoList/{id}/{invoiceState}?startDate={startDate}&endDate={endDate}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInvoiceInfoList-id-invoiceState_startDate_endDate)
- [ ] [GET api/{database}/SupplierInvoiceInfoList/{id}?startDate={startDate}&endDate={endDate}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInvoiceInfoList-id_startDate_endDate)
- [ ] [GET api/{database}/SupplierInvoiceInfoList/{Id}?invoiceState={invoiceState}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInvoiceInfoList-Id_invoiceState)
- [ ] [GET api/{database}/SupplierInvoiceInfoList/{Id}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInvoiceInfoList-Id)

## SupplierInvoiceStatistics

- [ ] [GET api/{database}/SupplierInvoiceStatistics/{supplierId}?referenceDate={referenceDate}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInvoiceStatistics-supplierId_referenceDate)
- [ ] [GET api/{database}/SupplierInvoiceStatistics/{supplierId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierInvoiceStatistics-supplierId)

## SupplierNVL

- [ ] [GET api/{database}/SupplierNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierNVL)

## SupplierPersonNVL

- [ ] [GET api/{database}/SupplierPersonNVL/{supplierId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-SupplierPersonNVL-supplierId)

## Task

- [ ] [DELETE api/{database}/Task/{taskId}](https://api.online.unit4.nl/V19/Help/Api/DELETE-api-database-Task-taskId)
- [ ] [GET api/{database}/Task/{taskId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-Task-taskId)
- [ ] [POST api/{database}/Task](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-Task)
- [ ] [PUT api/{database}/Task/{taskId}](https://api.online.unit4.nl/V19/Help/Api/PUT-api-database-Task-taskId)

## TaskList

- [ ] [GET api/{database}/TaskList/{organizationId}?customerId={customerId}&supplierId={supplierId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-TaskList-organizationId_customerId_supplierId)
- [ ] [GET api/{database}/TaskList/{organizationId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-TaskList-organizationId)
- [ ] [POST api/{database}/TaskList](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-TaskList)

## TaskPriorityNVL

- [ ] [GET api/{database}/TaskPriorityNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-TaskPriorityNVL)

## TaskTypeNVL

- [ ] [GET api/{database}/TaskTypeNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-TaskTypeNVL)

## Timesheet

- [ ] [GET api/{database}/Timesheet/OpenOrNew/{employeeId}?yearNumber={yearNumber}&mostRecently={mostRecently}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-Timesheet-OpenOrNew-employeeId_yearNumber_mostRecently)
- [ ] [GET api/{database}/Timesheet/OpenOrNew/{employeeId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-Timesheet-OpenOrNew-employeeId)
- [ ] [GET api/{database}/Timesheet/{employeeId}/{yearNumber}/{weekNumber}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-Timesheet-employeeId-yearNumber-weekNumber)
- [ ] [POST api/{database}/Timesheet](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-Timesheet)
- [ ] [PUT api/{database}/Timesheet/{employeeId}/{yearNumber}/{weekNumber}](https://api.online.unit4.nl/V19/Help/Api/PUT-api-database-Timesheet-employeeId-yearNumber-weekNumber)

## TimesheetLineEntryTypeNVL

- [ ] [GET api/{database}/TimesheetLineEntryTypeNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-TimesheetLineEntryTypeNVL)

## TimesheetLineProductTypeNVL

- [ ] [GET api/{database}/TimesheetLineProductTypeNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-TimesheetLineProductTypeNVL)

## TimesheetLineTypeNVL

- [ ] [GET api/{database}/TimesheetLineTypeNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-TimesheetLineTypeNVL)

## TitleNVL

- [ ] [GET api/{database}/TitleNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-TitleNVL)

## TristateNVL

- [ ] [GET api/{database}/TristateNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-TristateNVL)
...
- [ ] [GET api/{database}/VatCodeNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-VatCodeNVL)

## VatScenarioInfo

- [ ] [GET api/{database}/VatScenarioInfo/{scenarioId}/{fiscalYear}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-VatScenarioInfo-scenarioId-fiscalYear)

## VatScenarioRuleInfo

- [ ] [GET api/{database}/VatScenarioRuleInfo/{scenarioId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-VatScenarioRuleInfo-scenarioId)

## VatScenarioRuleInfoList

- [ ] [GET api/{database}/VatScenarioRuleInfoList/{fiscalYear}?scenarioId={scenarioId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-VatScenarioRuleInfoList-fiscalYear_scenarioId)
- [ ] [GET api/{database}/VatScenarioRuleInfoList?fiscalYear={fiscalYear}&scenarioId={scenarioId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-VatScenarioRuleInfoList_fiscalYear_scenarioId)
- [ ] [GET api/{database}/VatScenarioRuleInfoList?fiscalYear={fiscalYear}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-VatScenarioRuleInfoList_fiscalYear)
- [ ] [GET api/{database}/VatScenarioRuleInfoList](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-VatScenarioRuleInfoList)

## VatTypeNVL

- [ ] [GET api/{database}/VatTypeNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-VatTypeNVL)

## Warehouse

- [ ] [DELETE api/{database}/Warehouse/{warehouseId}](https://api.online.unit4.nl/V19/Help/Api/DELETE-api-database-Warehouse-warehouseId)
- [ ] [GET api/{database}/Warehouse/Preferred](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-Warehouse-Preferred)
- [ ] [GET api/{database}/Warehouse/{warehouseId}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-Warehouse-warehouseId)
- [ ] [POST api/{database}/Warehouse](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-Warehouse)
- [ ] [PUT api/{database}/Warehouse/{warehouseId}](https://api.online.unit4.nl/V19/Help/Api/PUT-api-database-Warehouse-warehouseId)

## WarehouseNVL

- [ ] [GET api/{database}/WarehouseNVL](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-WarehouseNVL)

## WkrParameters

- [ ] [DELETE api/{database}/WkrParameters/{calendarYear}](https://api.online.unit4.nl/V19/Help/Api/DELETE-api-database-WkrParameters-calendarYear)
- [ ] [GET api/{database}/WkrParameters/{calendarYear}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-WkrParameters-calendarYear)
- [ ] [POST api/{database}/WkrParameters](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-WkrParameters)
- [ ] [PUT api/{database}/WkrParameters/{calendarYear}](https://api.online.unit4.nl/V19/Help/Api/PUT-api-database-WkrParameters-calendarYear)

# Commands

## ApproveInvoicePaymentCommand

- [ ] [POST api/{database}/ApproveInvoicePaymentCommand?invoiceId={invoiceId}&approverId={approverId}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-ApproveInvoicePaymentCommand_invoiceId_approverId)

## CalcSpecPriceCommand

- [ ] [POST api/{database}/CalcSpecPriceCommand?customerId={customerId}&productId={productId}&currencyId={currencyId}&quantity={quantity}&orderDate={orderDate}&vatIncluded={vatIncluded}&projectId={projectId}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-CalcSpecPriceCommand_customerId_productId_currencyId_quantity_orderDate_vatIncluded_projectId)

## CreatePaymentFileCommand

- [ ] [POST api/{database}/CreatePaymentFileCommand?bankId={bankId}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-CreatePaymentFileCommand_bankId)

## DmDocumentCreateReferenceCommand

- [ ] [POST api/{database}/DmDocumentCreateReferenceCommand?type={type}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-DmDocumentCreateReferenceCommand_type)

## GetCustomerIdCommand

- [ ] [POST api/{database}/GetCustomerIdCommand](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-GetCustomerIdCommand)

## GetInvoiceIdCommand

- [ ] [POST api/{database}/GetInvoiceIdCommand](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-GetInvoiceIdCommand)

## GetMandateIdCommand

- [ ] [POST api/{database}/GetMandateIdCommand](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-GetMandateIdCommand)

## GetNextJournalTransactionCommand

- [ ] [POST api/{database}/GetNextJournalTransactionCommand?fiscalYear={fiscalYear}&journalId={journalId}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-GetNextJournalTransactionCommand_fiscalYear_journalId)

## GetPersonIdCommand

- [ ] [POST api/{database}/GetPersonIdCommand](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-GetPersonIdCommand)

## GetSupplierIdCommand

- [ ] [POST api/{database}/GetSupplierIdCommand](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-GetSupplierIdCommand)

## IncrementPaymentReminderCounterCommand

- [ ] [POST api/{database}/IncrementPaymentReminderCounterCommand?invoiceId={invoiceId}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-IncrementPaymentReminderCounterCommand_invoiceId)

## IncrementPrintCounterCommand

- [ ] [POST api/{database}/IncrementPrintCounterCommand?printEntityType={printEntityType}&entityId={entityId}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-IncrementPrintCounterCommand_printEntityType_entityId)

## MailMessageCountCommand

- [ ] [POST api/{database}/MailMessageCountCommand?statesCriteria[0]={statesCriteria[0]}&statesCriteria[1]={statesCriteria[1]}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-MailMessageCountCommand_statesCriteria[0]_statesCriteria[1])

## ModifyAutoIdCommand

- [ ] [POST api/{database}/ModifyAutoIdCommand/Disable?type={type}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-ModifyAutoIdCommand-Disable_type)
- [ ] [POST api/{database}/ModifyAutoIdCommand/Enable?type={type}&startId={startId}&interval={interval}&length={length}&useLeadingZeroes={useLeadingZeroes}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-ModifyAutoIdCommand-Enable_type_startId_interval_length_useLeadingZeroes)

## ProcessOrderCommand

- [ ] [POST api/{database}/ProcessOrderCommand?journalId={journalId}&fiscalYear={fiscalYear}&periodNumber={periodNumber}&invoiceDate={invoiceDate}&orderId={orderId}&journalTransaction={journalTransaction}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-ProcessOrderCommand_journalId_fiscalYear_periodNumber_invoiceDate_orderId_journalTransaction)

## RegisterReminderCommand

- [ ] [POST api/{database}/RegisterReminderCommand?invoiceIds[0]={invoiceIds[0]}&invoiceIds[1]={invoiceIds[1]}&type={type}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-RegisterReminderCommand_invoiceIds[0]_invoiceIds[1]_type)

## SetIsPreferredBankCommand

- [ ] [POST api/{database}/SetIsPreferredBankCommand?bankId={bankId}&isPreferred={isPreferred}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-SetIsPreferredBankCommand_bankId_isPreferred)

## SmtpClientConfigurationPresentCommand

- [ ] [POST api/{database}/SmtpClientConfigurationPresentCommand](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-SmtpClientConfigurationPresentCommand)

## SplitJournalEntryCommand

- [ ] [POST api/{database}/SplitJournalEntryCommand?fiscalYear={fiscalYear}&journalId={journalId}&journalTransaction={journalTransaction}&sequenceNumber={sequenceNumber}&targetFiscalYear={targetFiscalYear}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-SplitJournalEntryCommand_fiscalYear_journalId_journalTransaction_sequenceNumber_targetFiscalYear)
- [ ] [POST api/{database}/SplitJournalEntryCommand/Revert?fiscalYear={fiscalYear}&journalId={journalId}&journalTransaction={journalTransaction}&sequenceNumber={sequenceNumber}&targetFiscalYear={targetFiscalYear}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-SplitJournalEntryCommand-Revert_fiscalYear_journalId_journalTransaction_sequenceNumber_targetFiscalYear)

## UpdateKeyPerformanceBenchmarkCommand

- [ ] [POST api/{database}/UpdateKeyPerformanceBenchmarkCommand?keyPerformanceIndicatorId={keyPerformanceIndicatorId}&value={value}](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-UpdateKeyPerformanceBenchmarkCommand_keyPerformanceIndicatorId_value)

## ValidSmtpClientConfigurationCommand

- [ ] [POST api/{database}/ValidSmtpClientConfigurationCommand](https://api.online.unit4.nl/V19/Help/Api/POST-api-database-ValidSmtpClientConfigurationCommand)

# Documents

## AccountOverviewDocument

- [ ] [GET api/{database}/Documents/AccountOverview/Sample?languageId={languageId}&format={format}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-Documents-AccountOverview-Sample_languageId_format)
- [ ] [GET api/{database}/Documents/AccountOverview/{customerId}?languageId={languageId}&format={format}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-Documents-AccountOverview-customerId_languageId_format)

## InvoiceDocument

- [ ] [GET api/{database}/Documents/Invoice/ByOrderId/{orderId}?languageId={languageId}&format={format}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-Documents-Invoice-ByOrderId-orderId_languageId_format)
- [ ] [GET api/{database}/Documents/Invoice/Sample?languageId={languageId}&format={format}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-Documents-Invoice-Sample_languageId_format)
- [ ] [GET api/{database}/Documents/Invoice/{invoiceId}?languageId={languageId}&format={format}](https://api.online.unit4.nl/V19/Help/Api/GET-api-database-Documents-Invoice-invoiceId_languageId_format)
